...
def pso_algorithm(dim, num_particles, max_iterations, chi,phi,func,domain):
    ...
    for _ in range(max_iterations):
        for i, particle in enumerate(particles):
            ...
            particle.velocity = chi * (particle.velocity + phi * r1 * (particle.best_position - particle.position) + phi * r2 * (global_best_position - particle.position))
...
best_position, best_fitness = pso_algorithm(dimension, num_particles, max_iterations, chi,phi,sphere_function,domain=[-5.12,5.12])
...
best_position, best_fitness = pso_algorithm(dimension, num_particles, max_iterations, chi,phi,rosenbrocks_function,domain=[-2.048,2.048])
...
best_position, best_fitness = pso_algorithm(dimension, num_particles, max_iterations, chi,phi,ackleys_function,domain=[-32.768,32.768])
...
best_position, best_fitness = pso_algorithm(dimension, num_particles, max_iterations, chi,phi,griewanks_function,domain=[-600,600])
...
best_position, best_fitness = pso_algorithm(dimension, num_particles, max_iterations, chi,phi,rastrigins_function,domain=[-5.12,5.12])
...
best_position, best_fitness = pso_algorithm(dimension, num_particles, max_iterations, chi,phi,weierstrass_function,domain=[-0.5,0.5])
